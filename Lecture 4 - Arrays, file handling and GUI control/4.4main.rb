  ...
  def button_down(id)
    case id
      ...
      when Gosu::MsLeft
        ...
        print("Cell clicked on is x: " + cell[0].to_s + " y: " + cell[1].to_s.chomp) 
        print(" ")
        if true
          if @columns[cell[0]][cell[1]].vacant == true
            if @columns[cell[0]][cell[1]].east == nil || @columns[cell[0]][cell[1]].east.vacant == false 
              print("East: 0 ")
            elsif @columns[cell[0]][cell[1]].east.vacant == true
              print(" East: 1 ")
            end
            
            if @columns[cell[0]][cell[1]].west == nil || @columns[cell[0]][cell[1]].west.vacant == false 
              print("West: 0 ")
            elsif @columns[cell[0]][cell[1]].west.vacant == true
              print(" West: 1 ")
            end
            
            if @columns[cell[0]][cell[1]].north == nil || @columns[cell[0]][cell[1]].north.vacant == false 
              print("North: 0 ")
            elsif @columns[cell[0]][cell[1]].north.vacant == true
              print(" North: 1 ")
            end
            
            if @columns[cell[0]][cell[1]].south == nil || @columns[cell[0]][cell[1]].south.vacant == false 
              print("South: 0 ")
            elsif @columns[cell[0]][cell[1]].south.vacant == true
              print(" South: 1 ")
            end
            puts ""
          end
          ...
          if @columns[cell[0]][cell[1]].vacant == false
